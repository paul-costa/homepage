      ...
      setTimeout(() => {
         const appProjects: AppProject[] = [
          ...
          },
          {
            ...
            directLink: 'https://kantine.costapaul.com/',
            additionInfo: 'APK download available at: https://downloads.costapaul.com/kantine-4.apk',
          },
          {
            id: '14',
            title: 'Kantine 4.0 backend',
            status: {progress: 'finished/maintenance', language: 'node', classification: 'private', hostType: 'heroku'},
